...

{
  ...
  print "process_arch=$(uname -m)"
  print "hardware_arm64=$(/usr/sbin/sysctl -in hw.optional.arm64 2>/dev/null || print 0)"
  print "process_translated=$(/usr/sbin/sysctl -in sysctl.proc_translated 2>/dev/null || print 0)"
